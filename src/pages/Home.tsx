...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-white overflow-hidden">
      ...
      <section className="py-10 md:py-14 px-6 sm:px-8 md:px-12">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-text-secondary text-lg md:text-xl mb-6 max-w-2xl mx-auto max-sm:text-base max-sm:mb-5">
              Welcome to my digital canvas! I’m a designer who blends
              creativity, technology, and emotion to craft impactful
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="flex flex-wrap justify-center items-center gap-5 mb-6 text-sm text-text-secondary
                      max-sm:flex-col max-sm:gap-2 max-sm:mb-4"
            >
      ...
      {/* ---------------- ABOUT & SKILLS ---------------- */}
      <section className="py-12 px-6 sm:px-8 md:px-12">
      ...
      <section className="py-12 px-6 sm:px-8 md:px-12">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="text-center mb-10 max-sm:mb-6"
          >
