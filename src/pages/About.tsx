    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 md:px-8 bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.section
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.15 }}
          className="text-center py-12 sm:py-16 bg-secondary/20 rounded-2xl border border-gray-700/50"
        >
          <h2 className="font-mono text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">
            It's your time to shine.
          </h2>
          <p className="text-text-secondary mb-6 sm:mb-8 max-w-xl mx-auto text-sm sm:text-base">
          ...
          <motion.button
            whileHover={{ scale: 1.06 }}
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center justify-center bg-gradient-to-r from-accent to-accent-light px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-medium text-sm sm:text-base text-white shadow-md hover:shadow-lg transition-all duration-300"
          >
